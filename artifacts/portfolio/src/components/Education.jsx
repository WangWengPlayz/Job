...
export default function Education() {
  ...
  >
    ...
    /* Timeline Line (Desktop) */
              ...
              <div className="hidden md:block absolute left-[1.15rem] top-4 bottom-4 w-px bg-border" />
              {
    /* Timeline Line (Mobile) */
  }
              <div className="md:hidden absolute left-0 top-4 bottom-4 w-px bg-border" />
  ...
  >
                <div className="absolute left-[-2.35rem] md:left-2 top-1 w-4 h-4 rounded-full bg-background border-2 border-primary group-hover:bg-primary transition-colors z-10" />
  ...
  >
                <div className="absolute left-[-2.35rem] md:left-2 top-1 w-4 h-4 rounded-full bg-background border-2 border-muted-foreground group-hover:border-blue-500 transition-colors z-10" />
