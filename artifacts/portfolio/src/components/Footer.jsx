  ...
  >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[["About", "about"], ["Skills", "skills"], ["Services", "services"], ["Experience", "projects"]].map(([label, id]) => <li key={id}>
                  <a
    href={`#${id}`}
  ...
  >
        ...
        <div className="pt-8 border-t border-border space-y-4">
          <p className="text-center text-xs text-muted-foreground leading-relaxed max-w-xl mx-auto">
            <span className="font-semibold text-amber-500">Notice:</span> This website is for professional and job-seeking purposes only. Intended for potential employers and recruiters. Please respect my privacy if you are not here to hire.
          </p>
