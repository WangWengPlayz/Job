...
export default function Contact() {
  ...
  return <section id="contact" className="py-24 bg-muted/50 relative overflow-hidden">
      {
    /* Decorative background elements */
  }
      <div className="absolute top-0 right-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] rounded-full bg-primary/5 blur-3xl" />
        <div className="absolute bottom-[-10%] left-[-5%] w-[30%] h-[30%] rounded-full bg-blue-500/5 blur-3xl" />
      </div>
  ...
  >
                    {form.formState.isSubmitting ? <span className="flex items-center gap-2">Sending...</span> : <span className="flex items-center gap-2">
